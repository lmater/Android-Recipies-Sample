...
public class FavouritListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            index = ThreadLocalRandom.current().nextInt(DataBase.listRecipesFav.size());
        }
        ...
        try {
            ims = getAssets().open("imgs/"+DataBase.listRecipesFav.get(index).getUrl_img()+".jpg");
        } catch (IOException e) {
            e.printStackTrace();
        }
...
/*        FloatingActionButton fabContactUs = (FloatingActionButton) findViewById(R.id.fabAddFavourite);
        ...
        listview = (ListView) this.findViewById(R.id.listViewRecipesFav);
//        progressBar = (ProgressBar) rootView.findViewById(R.id.progressBarDelete);
        listview.setAdapter(new FavouritListActivity.ListviewStatAdapter(listview.getContext(), DataBase.listRecipesFav));
    ...
    public class ListviewStatAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            // TODO Auto-generated method stub
            final FavouritListActivity.ListviewStatAdapter.listviewHolder holder;
            final Recipe Gr = listRecipes.get(position);
//            if(convertView == null){
            convertView = mInflater.inflate(R.layout.layout_favourit_list, null);
            holder = new FavouritListActivity.ListviewStatAdapter.listviewHolder();
...
//            holder.recipeImage.setImageResource(getAssets().open(Gr.getUrl_img()+".jpg"));
            ...
            holder.recipeLabel.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent toRecipe = new Intent(FavouritListActivity.this, RecipeActivity.class);
                    toRecipe.putExtra("recipe",""+position);
                    toRecipe.putExtra("from","fav");
