...
public class AboutPage {
     ...
     * a predefined title string
     *
     * @param tel the phone number to send to
     * @return this AboutPage instance for builder pattern support
     */
    public AboutPage addPhone(String tel) {
        return addPhone(tel, mContext.getString(R.string.about_phone));
    }
     ...
     * a predefined title string
     *
     * @param tel the phone number address to send to
     * @return this AboutPage instance for builder pattern support
     */
    public AboutPage addTel(String tel) {
        return addEmail(tel, mContext.getString(R.string.about_phone));
    }
    ...
    public AboutPage addEmail(String email, String title) {
        ...
        emailElement.setIconTint(R.color.about_gmail_color);
    ...
    public AboutPage addPhone(String phone, String title) {
        ...
        phoneElement.setIconDrawable(R.mipmap.callus);
        phoneElement.setIconTint(R.color.about_phone_color);
